...
$newsList = NewsController::getNewsByTag('editais');
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
        ...
        <section id="journal-main">
            <article class="hero">
                <div class="hero-content">
                    <span>EDITAIS</span>
                    <h1>Notícias de editais</h1>
                    <p>Veja os últimos eventos e resultados do Grêmio Estudantil.</p>
                </div>
            </article>
                ...
                <?php if (empty($newsList)): ?>
                    <div class="card">
                        <div class="card-content">
                            <h3>Sem notícias sobre editais novos</h3>
